...
### 验证范围
8 个新创建的非教务通用模板，每个使用「简单」难度知识文件。

| 模板名称 | 字段数 | 状态 |
|----------|--------|------|
| 个人贷款申请表 | 14 | ✅ 模板解析 + cofill 生成 |
| 产品质量检测报告 | 19 | ✅ 模板解析 + cofill 生成 |
| 住院登记表 | 24 | ✅ 模板解析 + cofill 生成 |
| 发货委托单 | 19 | ✅ 模板解析 + cofill 生成 |
| 员工入职登记表 | 23 | ✅ 模板解析 + cofill 生成 |
| 团队旅游报名表 | 14 | ✅ 模板解析 + cofill 生成 |
| 房屋信息登记表 | 15 | ✅ 模板解析 + cofill 生成 |
| 行政审批申请表 | 17 | ✅ 模板解析 + cofill 生成 |
